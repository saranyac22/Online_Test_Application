...
function checkAnswer() {
    ...
    if(jsonData.length-1 < i){
        ...
        document.write("\n");
        document.write("<div style='color:black;font-size:18pt;text-align:center;'>Thank you for taking the test! </div>");
        document.write("\n");
        document.write("<div style='color:black;font-size:18pt;text-align:center;'>Your final score is : "+correctCount+"</div>");
        document.write("</body>");
    }
